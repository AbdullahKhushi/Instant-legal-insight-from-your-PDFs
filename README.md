# Instant-legal-insight-from-your-PDFs

## Description
Instant legal insight from your PDFs using an advanced AI chat interface. Built with Streamlit, it features a user-friendly interface and leverages modern AI technologies for efficient handling and discussion of legal texts.
...
1. Clone the repository:
   ```bash
   git clone git@github.com:AbdullahKhushi/Instant-legal-insight-from-your-PDFs.git
   cd Instant-legal-insight-from-your-PDFs
   ```
...
# Author
Abdullah Khushi  
Email: abdullahkhushi0305@gmail.com
